...
Textbooks, like Junqueira’s Basic Histology [@wikidata:Q102104590] work as manuals that perpetuate the paradigms (in the Kuhnian sense) [@wikidata:Q1868040] of what we know about a few hundred cell types.
...
The similar term “cell state” is used both to describe classes (e.g. activated T-cell) and real-world observations (e.g. the current state of a specific cell).

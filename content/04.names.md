...
It is useful to distill these different concepts into names. Given the importance of the concept of species in biological classification [@url:http://phylonames.org/code/preface/], we derive a species-centric view on the naming of classes of cell types. 

...
In this article, we have proposed a set of three rules (rigorous description, taxon scope restriction, and theoretical usefulness) and one recommendation (link to an ontology of cell types) to define cell types.

...
<small><em>
This manuscript
([permalink](https://lubianat.github.io/technotype/v/c3d10326eabbacca77b241bd5d71112ac936a7c6/))
was automatically generated
from [lubianat/technotype@c3d1032](https://github.com/lubianat/technotype/tree/c3d10326eabbacca77b241bd5d71112ac936a7c6)
on October 7, 2020.
</em></small>
...
Sabina Leonelli stated that the challenges brought up by big data in biology require an advance of our philosophical theories [@doi:10.7554/eLife.47381]. We agree, and argue that the inverse is also true: to advance the theoretical foundations of modern biology, we need to harness the power of computational tools. Computational ontologies provide a solution for dealing with complex concepts. Classes in ontologies can have alpha-numeric identifiers. We can, thus assign each technotype a Unique Resource Identifier, a URI, similar to the Cell Ontology (CL) [@doi:10.1186/gb-2005-6-2-r21] [@doi:10.1186/1471-2105-12-6] [@doi:10.1186/s13326-016-0088-7] or Wikidata [@doi:10.7554/eLife.52614] [@https://www.wikidata.org/]. 
 ...
 The quest for naming systems is related to the quest for defining cell types, and exciting proposals are already arising. [@url:https://arxiv.org/abs/2006.05406] Nevertheless, the definition of rules for _naming_ cell types is outside the scope of this article, and abstracted away via semantically void identifiers. 
 We devoted our effort to refining the logical aspects of cell-type definitions, which might be combined with any commonly agreed naming system.
